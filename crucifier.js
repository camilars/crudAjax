...
function editar(id) {
        ...
        bot.innerHTML = '<a href="javascript:editado(\''+ id +'\')">enviar</a>'; //inserir o botao de enviar a alteracao
}
...
function editado(id) {
        ...
        envia.innerHTML = '<a href="javascript:editar(\''+id+'\')">alterar</a>'; //depois de enviar, mostrar de novo o botão de editar
        xmlhttp = new ajax();
...
function addrow(id) {
        ...
        b.innerHTML='<span id="enviar'+id+'"><a href="javascript:editar(\''+id+'\')">alterar</a></span><br><a href="java script:;" onclick="deleterow(\''+id+'\', this.parentNode.parentNode.rowIndex);">del</a>'; //na quarta coluna, inserir as opções
}
